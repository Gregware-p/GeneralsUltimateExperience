...
namespace GeneralsUltimateExperience
{
    ...
    public static class CustomMessageBox
    {
        ...
        /// </summary>
        /// <param name="owner">A window that represent the owner window of the messaage box</param>
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, button) { Owner = owner };
            msg.ShowDialog();
            return msg.Result;
        }
        /// <summary>
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, button, icon) { Owner = owner };
            msg.ShowDialog();
            return msg.Result;
        }
        /// <summary>
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OK) { Owner = owner };
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OK, icon) { Owner = owner };
            msg.OkButtonText = okButtonText;
            msg.ShowDialog();
            return msg.Result;
        }
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OKCancel) { Owner = owner };
            msg.OkButtonText = okButtonText;
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OKCancel, icon) { Owner = owner };
            msg.OkButtonText = okButtonText;
            msg.CancelButtonText = cancelButtonText;
            msg.ShowDialog();
            return msg.Result;
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNo) { Owner = owner };
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNo, icon) { Owner = owner };
            msg.YesButtonText = yesButtonText;
            msg.NoButtonText = noButtonText;
            msg.ShowDialog();
            return msg.Result;
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNoCancel) { Owner = owner };
            msg.YesButtonText = yesButtonText;
            msg.NoButtonText = noButtonText;
            msg.CancelButtonText = cancelButtonText;
            msg.ShowDialog();
        ...
        {
            CustomMessageBoxWindow msg = new CustomMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNoCancel, icon) { Owner = owner };
            msg.YesButtonText = yesButtonText;
            msg.NoButtonText = noButtonText;
            msg.CancelButtonText = cancelButtonText;
            msg.ShowDialog();
